<div class="modal fade" id="modalFilterColumns" tabindex="-1" producttype="dialog" aria-labelledby="modalFilterColumnsLabel"
    aria-hidden="true">
    <!-- .modal-dialog -->
    <div class="modal-dialog modal-dialog-scrollable" producttype="document">
        <!-- .modal-content -->
