   ...
   <div class="top-bar-list">
      ...
      <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
         ...
         <ul class="header-nav nav">
            <!-- activities -->
            @include('productsupplier::layouts.includes.activities')   
            <!-- /.activities -->
            <!-- messages -->
            @include('productsupplier::layouts.includes.messages')   
            <!-- /messages -->
            <!-- shortcodes -->
            @include('productsupplier::layouts.includes.shortcodes')
            <!-- /shortcodes -->
         </ul>
         <!-- /.nav -->
         <!-- .btn-account -->
         @include('productsupplier::layouts.includes.account')
         <!-- /.btn-account -->
      </div>
      <!-- /.top-bar-item -->
      <!-- /.top-bar-item -->
