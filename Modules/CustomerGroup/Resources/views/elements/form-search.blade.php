<form action="{{ route('customergroup.index') }}" method="GET" id="form-search">
    ...
    <!-- #modalFilterColumns -->
    @include('customergroup::elements.modals.modalFilterColumns')
    <!-- /#modalFilterColumns -->    
    <!-- #modalSaveSearch -->
    @include('customergroup::elements.modals.modalSaveSearch')
    <!-- /#modalSaveSearch -->
</form>