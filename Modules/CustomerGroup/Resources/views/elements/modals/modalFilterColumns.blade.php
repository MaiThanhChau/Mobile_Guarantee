<div class="modal fade" id="modalFilterColumns" tabindex="-1" customergroup="dialog" aria-labelledby="modalFilterColumnsLabel"
    aria-hidden="true">
    <!-- .modal-dialog -->
    <div class="modal-dialog modal-dialog-scrollable" customergroup="document">
        <!-- .modal-content -->
