<form action="{{ route('inventorydetails.index') }}" method="GET" id="form-search">
    ...
    @include('inventorydetails::elements.modals.modalFilterColumns')
    @include('inventorydetails::elements.modals.modalSaveSearch')
</form>