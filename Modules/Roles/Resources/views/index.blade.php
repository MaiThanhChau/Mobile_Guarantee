...
<header class="page-title-bar">
    <div class="d-flex justify-content-between">
        ...
        <div class="btn-toolbar">
            <a href="{{ route('roles.create') }}" class="btn btn-primary">Thêm mới</a>
        </div>
    </div>
</header>
    ...
    <div class="card card-fluid">
        ...
        <div class="card-header">
            ...
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link active show" href="{{ route('roles.index') }}"> Tất cả </a>
                </li>
            </ul>
            <!-- /.nav-tabs -->
        </div>
        ...
        <div class="card-body">
            ...
            <!-- .table-responsive -->
            <div class="text-muted"> Trang {{ $items->currentPage() }}/{{ $items->lastPage() }}, tổng
                {{ $items->total() }} kết quả </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <a class="btn-account" href="{{ route('roles.edit',$item->id) }}">
                                 ...
                                 <span class="account-summary">
                                    ...
                                    <span class="account-description">
                                       <span class="text-success">{{ $item->created_at }}</span>
                                    </span>
                                 </span>
