<div class="modal fade" id="modalSaveSearch" tabindex="-1" role="dialog" aria-labelledby="modalSaveSearchLabel"
    aria-hidden="true">
    <!-- .modal-dialog -->
            ...
            <div class="modal-body">
                ...
                <div id="search-columns">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input text"><input type="text" name="name" class="form-control" id="name-search"></div>
                    </div>
                </div>
                <!-- #filter-columns -->
                <!-- .btn -->
