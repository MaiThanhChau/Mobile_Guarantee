<form action="{{ route('customers.index') }}" method="GET" id="form-search">
    ...
    <!-- #modalFilterColumns -->
    @include('customers::elements.modals.modalFilterColumns')
    <!-- /#modalFilterColumns -->    
    <!-- #modalSaveSearch -->
    @include('customers::elements.modals.modalSaveSearch')
    <!-- /#modalSaveSearch -->
</form>