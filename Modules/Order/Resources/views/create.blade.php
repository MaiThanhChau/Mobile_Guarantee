                            ...
                            <div class="col-lg-8">
                                <div class="card card-fluid">
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="publisher keep-focus focus active">
                                                    ...
                                                    <div class="publisher-input">
                                                        <textarea name="order_note" class="form-control"
                                                            placeholder="Nhập ghi chú đơn hàng" id="order-note"
                                                            rows="5"></textarea>
                                                    </div><!-- /.publisher-input -->
                                                </div>
                                            </div>
                                                        ...
                                                        <tr>
                                                            <td class="text-left color-subtext">
                                                                <a href="javascript:;" data-toggle="modal"
                                                                    ...
                                                                    data-target=".add-discounts"><i
                                                                        class="fa fa-plus-circle"></i> Thêm khuyến
                                                                    mãi</a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right p-none-b pl10 ">
                                                                <input type="text" name="cost"
                                                                    ...
                                                                    autocomplete="off" data-mask="currency" id="cost"
                                                                    value="0" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div class="modal fade has-shown add-discounts" id="modalDiscount" tabindex="-1"
                                            role="dialog" aria-labelledby="modalDiscountLabel" style="display: none;"
                                            aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-alt">
                                                                <div class="input-group-prepend">
                                                                    <button
                                                                        class="btn btn-secondary btn-discount_type active"
                                                                ...
                                                                <input type="text" name="discount_amount"
                                                                    class="form-control price" id="discount-amount" />
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text cr_symbol">đ</span>
                                                                </div>
                                                            </div>
                                                            <input type="hidden" name="discount_type" class="d-none"
                                                                id="discount-type" value="fixed_amount" />
                                                        </div>
                                                        <div class="form-group">
                                                            Hoặc
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group has-clearable">
                                                                <button type="button"
                                                                    class="close trigger-submit trigger-submit-delay"
                                                                    aria-label="Close">
                                                                    <span aria-hidden="true"><i
                                                                            class="fa fa-times-circle"></i></span>
                                                                </button>
                                                                <input type="text" name="discounted_code"
                                                                    id="discounted_code" class="form-control"
                                                    ...
                                                    <div class="modal-footer justify-content-start modal-body-scrolled">
                                                        <button type="button" class="btn btn-primary"
                                                            id="apply-coupon">Áp dụng</button>
                                        ...
                                        <div class="modal fade has-shown add-note" id="modal-note" tabindex="-1"
                                            role="dialog" aria-labelledby="modalNoteLabel" style="display: none;"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header modal-body-scrolled">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="order-item-note">Nhập nội dung ghi
                                                                chú</label><textarea name="order_item_note"
                                                                class="form-control" id="order-item-note"
                                                                rows="5"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer justify-content-start modal-body-scrolled">
                                                        <button type="button" class="btn btn-primary"
                                                            id="apply-note">Áp dụng</button>
                                                        <button type="button" data-dismiss="modal" class="btn btn-light"
                                                            id="clear-filter">Hủy</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade has-shown add-payments" id="modal-payments" tabindex="-1"
                                            role="dialog" aria-labelledby="modalPaymentsLabel" style="display: none;"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="payment-status">Hình thức thanh
                                                                toán</label><select name="payment_status"
                                                                class="form-control" id="payment-status">
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="col">
                                                                    <input type="text" name="final_cart_total"
                                                                        ...
                                                                        id="final-cart-total" readonly="readonly"
                                                                        autocomplete="off" />
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                    ...
                                                    <div class="modal-footer justify-content-start modal-body-scrolled">
                                                        <button type="button" class="btn btn-primary"
                                                            id="apply-payments">Áp dụng</button>
                                                        <button type="button" data-dismiss="modal" class="btn btn-light"
                                                            id="clear-filter">Hủy</button>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="shipping-method-id">Phương thức vận
                                                        chuyển</label><select name="shipping_method_id"
                                                        class="custom-select" id="shipping-method-id">
                                                ...
                                                <div class="form-group">
                                                    <label for="payment-method-id">Phương thức thanh
                                                        toán</label><select name="payment_method_id"
                                                        class="custom-select" id="payment-method-id">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="supporter-ids">Nhân viên kinh doanh</label><select
                                                        name="supporter_ids" class="custom-select" data-toggle="select2"
                                                        data-placeholder="Chọn nhân viên kinh doanh"
                                                        id="supporter-ids">
                                ...
                                <div class="card card-fluid">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group d-none">
                                            <label for="type">Loại xuất</label><select name="type"
                                        ...
                                        <div class="form-group">
                                            <label for="warehouse-id">Xuất từ kho hàng</label><select
                                                name="warehouse_id" class="custom-select" id="warehouse-id">
                                    ...
                                    <div class="card-body border-top">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="customer-id">Chọn khách hàng trong hệ thống</label><select
                                                name="customer_id" class="ajax-sellect form-control"
                                                id="customer-id"></select><small class="text-muted">Để trống nếu như
                                                là khách hàng mới</small>
                                            <div><small class="text-success applying-wholesale"
                                                    style="display: none;">Đang áp dụng bảng giá</small></div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="address">Địa chỉ</label><input type="text" name="address"
                                                class="form-control" required="required" maxlength="255" id="address" />
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label><input type="email" name="email"
                                                class="form-control" required="required" maxlength="255" id="email"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="card-body border-top">
                                        ...
                                        <div class="form-group">
                                            <label for="order-status">Trạng thái đơn hàng</label><select
                                                name="order_status" class="form-control" id="order-status">
                                        ...
                                        <div class="form-group">
                                            <label for="tags">Thẻ đơn hàng</label><input type="hidden" name="tags"
                                                value="" /><select name="tags[]" multiple="multiple"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-alt flatpickr">
                                                <input type="text" name="created" class="form-control"
                                                    disabled="disabled" required="required" data-input="" id="created"
                                                    value="2021-07-22" />
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="submit" name="save_request"
                                                class="btn btn-info save_request">Xuất Kho </button>
