<form action="{{ route('producttype.index') }}" method="GET" id="form-search">
    ...
    <!-- #modalFilterColumns -->
    @include('producttype::elements.modals.modalFilterColumns')
    <!-- /#modalFilterColumns -->    
    <!-- #modalSaveSearch -->
    @include('producttype::elements.modals.modalSaveSearch')
    <!-- /#modalSaveSearch -->
</form>