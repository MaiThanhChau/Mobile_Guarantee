   ...
   <div class="top-bar-list">
      ...
      <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
         ...
         <ul class="header-nav nav">
            <!-- activities -->
            @include('producttype::layouts.includes.activities')   
            <!-- /.activities -->
            <!-- messages -->
            @include('producttype::layouts.includes.messages')   
            <!-- /messages -->
            <!-- shortcodes -->
            @include('producttype::layouts.includes.shortcodes')
            <!-- /shortcodes -->
         </ul>
         <!-- /.nav -->
         <!-- .btn-account -->
         @include('producttype::layouts.includes.account')
         <!-- /.btn-account -->
      </div>
      <!-- /.top-bar-item -->
      <!-- /.top-bar-item -->
