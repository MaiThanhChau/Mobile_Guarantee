<form action="{{ route('product.index') }}" method="GET" id="form-search">
    ...
    <!-- #modalFilterColumns -->
    @include('product::elements.modals.modalFilterColumns')
    <!-- /#modalFilterColumns -->    
    <!-- #modalSaveSearch -->
    @include('product::elements.modals.modalSaveSearch')
    <!-- /#modalSaveSearch -->
</form>