   ...
   <div class="top-bar-list">
      ...
      <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
         ...
         <ul class="header-nav nav">
            <!-- activities -->
            @include('product::layouts.includes.activities')   
            <!-- /.activities -->
            <!-- messages -->
            @include('product::layouts.includes.messages')   
            <!-- /messages -->
            <!-- shortcodes -->
            @include('product::layouts.includes.shortcodes')
            <!-- /shortcodes -->
         </ul>
         <!-- /.nav -->
         <!-- .btn-account -->
         @include('product::layouts.includes.account')
         <!-- /.btn-account -->
      </div>
      <!-- /.top-bar-item -->
      <!-- /.top-bar-item -->
