                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ route('product.index') }}"><i
                                        class="breadcrumb-icon fa fa-angle-left mr-2"></i>Trở về</a>
                            </li>
                        </ol>
                    </nav>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="home">
                                    <div class="card card-fluid">
                                        ...
                                        <div class="card-body">
                                            <!-- form -->
                                            <form method="post" accept-charset="utf-8" action="{{ route('product.store') }}" enctype= "multipart/form-data">
                                            @csrf   
                                            <div class="form-row">
                                                <label for="title" class="col-md-3">Tên</label> 
                                                <div class="col-md-9 mb-3">
                                                <input type="text" name="name" class="form-control" placeholder="Tên" requiredid="name">            
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-9 mb-3">
                                                        <input type="text" name="sku" class="form-control"
                                                            placeholder="Mã SKU" required="required" maxlength="255"
                                                            id="sku">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-9 mb-3">
                                                        <textarea style="height:110px" name="description"
                                                            class="form-control" placeholder="Mô tả"
                                                            required="description" maxlength="255"
                                                            id="descrition"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-9 mb-3">
                                                        <input type="text" name="buy_price" class="price form-control"
                                                            placeholder="Giá nhập" data-mask="currency"
                                                            required="required" id="buy_price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-9 mb-3">
                                                        <input type="text" name="sell_price" class="price form-control"
                                                            placeholder="Giá bán" required="required" id="sell_price">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <label for="collection_id" class="col-md-3">Thời gian bảo
                                                        hành</label>
                                                    <div class="col-md-9 mb-3">
                                                        <select name="guarantee_time" class="custom-select"
                                                            id="supplier-id">
