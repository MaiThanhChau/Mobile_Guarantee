<form action="{{ route('saleoff.index') }}" method="GET" id="form-search">
    ...
    <!-- #modalFilterColumns -->
    @include('saleoff::elements.modals.modalFilterColumns')
    <!-- /#modalFilterColumns -->    
    <!-- #modalSaveSearch -->
    @include('saleoff::elements.modals.modalSaveSearch')
    <!-- /#modalSaveSearch -->
</form>