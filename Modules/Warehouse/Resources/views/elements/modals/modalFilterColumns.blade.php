<div class="modal fade" id="modalFilterColumns" tabindex="-1" warehouse="dialog" aria-labelledby="modalFilterColumnsLabel"
    aria-hidden="true">
    <!-- .modal-dialog -->
    <div class="modal-dialog modal-dialog-scrollable" warehouse="document">
        <!-- .modal-content -->
