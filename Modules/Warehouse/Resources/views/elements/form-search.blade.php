<form action="{{ route('warehouse.index') }}" method="GET" id="form-search">
    ...
    <!-- #modalFilterColumns -->
    @include('warehouse::elements.modals.modalFilterColumns')
    <!-- /#modalFilterColumns -->    
    <!-- #modalSaveSearch -->
    @include('warehouse::elements.modals.modalSaveSearch')
    <!-- /#modalSaveSearch -->
</form>