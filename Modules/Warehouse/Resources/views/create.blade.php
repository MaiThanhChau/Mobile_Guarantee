...
<header class="page-title-bar">
    ...
    <div class="d-md-flex align-items-md-start">
        <h1 class="page-title mr-sm-auto">Tạo Kho Hàng</h1><!-- .btn-toolbar -->
...
<div class="page-section">
    ...
    <div class="row">
        ...
        <!-- grid column -->
        <div class="col-lg-8">
            <form method="post" accept-charset="utf-8" action="{{ route('warehouse.store') }}">
                @csrf
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9 mb-3">
                                        <input type="email" name="email" class="form-control" placeholder="Email"
                                            required="required" maxlength="255" id="email" value="{{ old('email') }}" />
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9 mb-3">
                                        <input type="tel" name="phone" class="form-control" placeholder="Số điện thoại"
                                            required="required" maxlength="255" id="phone" value="{{ old('phone') }}" />
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-9 mb-3">
                                        <div class="custom-control custom-switch">
                                            <input type="hidden" name="status" value="0" /><input type="checkbox"
                                                name="status" value="1" class="custom-control-input" id="status"> <label
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <label class="switcher-control switcher-control-success">
                                        <input type="hidden" name="import" value="0" /><input type="checkbox"
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <label class="switcher-control switcher-control-success">
                                        <input type="hidden" name="export" value="0" /><input type="checkbox"
